...
public class CursomcApplication  implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		caRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
		prRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "35135135155", TipoCliente.PESSOAFISICA);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("30/07/2017 00:00"), null);
